...
/* NEW
* The foreColor is the colour which all our methods will draw shapes in.
* C++ Signature: short foreColor;
*/
.section .data
.align 1
foreColor:
...
/* NEW
* SetForeColor changes the current drawing colour to the 16 bit colour in r0.
* C++ Signature: void SetForeColor(u16 colour);
*/
.section .text
.globl SetForeColor
SetForeColor:
